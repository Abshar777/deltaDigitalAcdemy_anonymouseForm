...
const questions: Question[] = [
  {
    ...
    type: "select",
    title: "1.How satisfied are you with the overall learning experience?",
    subtitle: " Overall Learning Experience",
    required: true,
  ...
  },
  {
    id: "lessonClarity",
    type: "select",
    title: "2.How clear were the lessons taught in class?",
    subtitle: "Lesson Clarity",
    required: true,
  ...
  },
  {
    ...
    type: "select",
    title: "3.How comfortable do you feel asking questions in class?",
    subtitle: "Comfort Asking Questions",
    required: true,
  ...
  },
  {
    id: "trainerSpeed",
    type: "select",
    title: "4.How fast does the trainer explain concepts?",
    subtitle: "Trainer Teaching Speed",
    required: true,
  ...
  },
  {
    ...
    type: "select",
    title: "5.How useful were the practical sessions in improving your skills?",
    subtitle: "Practical Sessions Usefulness",
    required: true,
  ...
  },
  {
    ...
    type: "select",
    title: "6.How clear is the admin staff in communicating updates?",
  ...
  },
  {
    ...
    type: "select",
    title: "7.How approachable is the trainer?",
    subtitle: "Trainer Approachability",
    required: true,
  ...
  },
  {
    ...
    type: "select",
    title: "8.How satisfied are you with classroom facilities?",
    subtitle: "Classroom Facilities",
    required: true,
  ...
  },
  {
    id: "recommendAcademy",
    type: "select",
    title: "9.Would you recommend Delta Digital Academy to others?",
  ...
  },
  {
    ...
    type: "textarea",
    title: "10.Any suggestions about academy, classes, or trainers?",
